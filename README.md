 ...
 **child_process** 模块主要可以通过 **spawn()** 和 **exec()** 两种方法来启动一个
 ...
 [1]: resource/images/1.png
 [2]: resource/images/2.png
 [3]: resource/images/3.png
 [4]: resource/images/4.png
 [5]: resource/images/5.png
 [6]: resource/images/6.png
 [7]: resource/images/7.png
 [8]: resource/images/8.png
 [9]: resource/images/9.png
